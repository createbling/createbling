...
<!--温度-->
      <div class="databox">
         <!--温度数据监测信息-->
          <div class="data left">
            <div class="data_top"><p>实时温度</p></div>
            <div class="data_main" id="temp"></div>
          </div>
          <!--温度监控设备信息-->
          <div class="equipment right">
            <div class="data_top"><p>温度传感器电压</p></div>
      ...
      <div class="databox">
         <!--湿度数据监测信息-->
          <div class="data right">
            <div class="data_top"><p>实时湿度</p></div>
            <div class="data_main" id="humidity"></div>
          </div>
          <!--湿度监控设备信息-->
          <div class="equipment left">
            <div class="data_top"><p>湿度传感器电压</p></div>
            <div class="equip_main">
              <!--标准值-->
              <div class="valuebox">
                <p><span>标准值</span></p>
                <div class="value"><i class="iconfont">&#xe601;</i><span>45</span><b>/V</b></div>
              </div>
              <!--当前值-->
              <div class="valuebox">
                <p><span class="b_qing">当前值</span></p>
                <div class="value qing"><i class="iconfont qing">&#xe601;</i><span class="qing" id="humvol">43</span><b class="qing">/V</b></div>
              </div>
            </div>
          </div>
      </div>
...
<!--CO2-->
      <div class="databox">
         <!--CO2数据监测信息-->
          <div class="data left">
            <div class="data_top"><p>实时co2</p></div>
            <div class="data_main" id="co2"></div>
          </div>
          <!--CO2监控设备信息-->
          <div class="equipment right">
            <div class="data_top"><p>co2传感器电压</p></div>
            <div class="equip_main">
              <!--标准值-->
              <div class="valuebox">
                <p><span>标准值</span></p>
              ...
              <div class="valuebox">
                <p><span class="b_qing">当前值</span></p>
               <div class="value qing"><i class="iconfont qing">&#xe601;</i><span class="qing" id="c02vol">43</span><b class="qing">/V</b></div>
              </div>
            </div>
          </div>
      </div>
