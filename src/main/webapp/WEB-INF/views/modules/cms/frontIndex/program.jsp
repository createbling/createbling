							...
							<div class="inputbox">
								...
								<div class="inputbox_right">
									<div class="nice-select" name="nice-select">
										<input name="crop" id="input" type="text" value="==选择作物=="
											readonly />
										<ul>
...
-->
            ...
            -->
							...
							<div class="result_box pink">
								<p>
									<span class="b_pink">温度设置</span><span class="close">×</span>
								</p>
								<div class="package">
									<div class="val_icon">
										<i class="iconfont">&#xe609;</i>
							...
							<div class="result_box cray">
								<p>
									<span class="b_cray">土壤PH值设置</span><span class="close">×</span>
								</p>
								<div class="package">
									<div class="val_icon">
										<i class="iconfont">&#xe629;</i>
							...
							<div class="result_box pink nth">
								<p>
									<span class="b_pink">湿度设置</span><span class="close">×</span>
								</p>
								<div class="package">
									<div class="val_icon">
										<i class="iconfont">&#xe6bb;</i>
							...
							<div class="result_box yellow">
								<p>
									<span class="b_yellow">CO2浓度设置</span><span class="close">×</span>
								</p>
								<div class="package">
									<div class="val_icon">
										<i class="iconfont">&#xe8c2;</i>
							...
							<div class="result_box pink">
								<p>
									<span class="b_pink">种植密度</span><span class="close">×</span>
								</p>
								<div class="package">
									<div class="val_icon">
										<i class="iconfont">&#xe610;</i>
							...
							<div class="result_box blue nth">
								<p>
									<span class="b_blue">布局情况</span><span class="close">×</span>
								</p>
								<div class="package">
									<div class="val_icon">
										<i class="iconfont">&#xe618;</i>
