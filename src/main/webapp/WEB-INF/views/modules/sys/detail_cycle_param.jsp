	...
	<form:form id="inputForm" modelAttribute="area" action="${ctx}/sys/area/save" method="post" class="form-horizontal">
	  ...
	  <div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="unit" htmlEscape="false" maxlength="50" class="required" value="选择环境参数则填写"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="start" htmlEscape="false" maxlength="50" id="start" value="选择生长周期则填写"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="end" htmlEscape="false" maxlength="50" id="end" value="选择生长周期则填写"/>
