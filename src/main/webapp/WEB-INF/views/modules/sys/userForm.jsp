...
<body>
	...
	<form:form id="inputForm" modelAttribute="user"
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="area" name="area.id" value="${user.area.id}"
					labelName="area.name" labelValue="${user.area.name}" title="节点"
					url="/sys/area/treeData?type=1" cssClass="required"
