...
.formodif input[type='text']{border: none; width: 97%;height: 100%;padding-left: 5px;}
...
<%--  <ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/expert/select">专家配置</a></li>
		<shiro:hasPermission name="sys:expert:edit"><li  class="active"><a href="${ctx}/sys/expert/modify">专家修改</a></li></shiro:hasPermission>
	</ul> --%>
...
<script type="text/javascript">
    ...
    function getTop(e){
       ...
       var brother1=e.id;
       $("#table").attr("action","${ctx}/sys/expert/updateExpertValue?plant_id=${plant_id}&base_id=${base_id}&id="+brother1); 
