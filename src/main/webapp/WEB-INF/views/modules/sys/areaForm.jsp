...
<body>
	<ul class="nav nav-tabs">
		<li><a
			href="${ctx}/sys/area/list?id=${area.parent.id}&parentIds=${area.parentIds}">节点列表</a></li>
		<li class="active"><a
			href="${ctx}/sys/office/form?id=${area.id}&parent.id=${area.parent.id}">节点<shiro:hasPermission
	...
	<form:form id="inputForm" modelAttribute="area"
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="office" name="parent.id"
					...
					labelValue="${area.parent.name}" title="节点"
					url="/sys/area/treeData" extId="${area.id}" cssClass=""
					allowClear="${area.currentUser.admin}" />
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="description" htmlEscape="false" rows="3"
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:checkboxes path="childDeptList"
						items="${fns:getDictList('sys_area_common')}" itemLabel="label"
