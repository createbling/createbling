...
/*login*/
.login{padding:1px 0 0 0;background:url(${ctxStatic}/images/login-bg.jpg) center top no-repeat #FFF;padding:150px 0 0 0;}
...
.login .box{position:relative;z-index:100;margin:0 auto;width:700px;height:320px;background:url(${ctxStatic}/images/login.png) center top no-repeat;}
.login .log{position:relative;width:370px;height:260px;margin:0 auto;padding:90px 0 0 20px;}
.login .logo{height:85px;position:absolute;top:15px;left:180px;background:url(${ctxStatic}/images/logo-login.png) no-repeat;width:350px;height:50px;}
...
.login .air-balloon.ab-1{width:43px;height:78px;background:url(${ctxStatic}/images/air-balloon-1.png) no-repeat;}
.login .air-balloon.ab-2{width:24px;height:31px;background:url(${ctxStatic}/images/air-balloon-2.png) no-repeat;}
.login .footer{position: fixed;left:0;bottom:0;z-index:-1;width:100%;height:198px;background:url(${ctxStatic}/images/login-foot.jpg) center bottom repeat-x;}
...
.text:hover{background-color:#FFF;}</style>
		...
		<div class="input">
			<div class="log">
				...
				<div class="pwd">
					...
					<input type="password" class="text" id="password" name="password" placeholder="密码" tabindex="2">
			...
			<sys:validateCode name="validateCode" inputCssStyle="margin-bottom:0;"/>
					...
					<input type="checkbox" id="rememberMe" name="rememberMe" ${rememberMe ? 'checked' : ''}/> 记住我</label>
					<div class="check"></div>
				</div>
				</form>
				<div class="tip"></div>
