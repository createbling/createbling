...
<body>
	...
	<div class="container-fluid breadcrumb">
		<div class="row-fluid span12">
			...
			<span class="span4">归属层级: ${role.area.name}</span>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<!-- <th>归属公司</th> -->
		<th>归属层级</th>
		<th>登录名</th><th>姓名</th><th>电话</th><th>手机</th><shiro:hasPermission name="sys:user:edit"><th>操作</th></shiro:hasPermission></tr></thead>
		<tbody>
