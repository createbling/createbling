...
<%--  <ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/expert/findPlantList?base_id=1">专家配置</a></li>
...
$(document).ready(function() {
 	$.ajax({  
     	 url: '/createbling/a/sys/expert/findSelectedValue',  
     	 type: 'get',  
...
/* 	$.getJSON("/createbling/a/sys/expert/findSelectedValue?plant_id=${plant_id}", function (data) {
		 var objs=eval(data);   
		alert("O(∩_∩)O  欢迎进入"+"${plant}"+"${plant_id}"+"专家值配置表！"+objs);
