 ...
 */
package com.createbling.modules.act.service.ext;
...
import com.createbling.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.createbling.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.createbling.modules.sys.entity.User(null, userId)))){
