...
import com.createbling.common.utils.excel.annotation.ExcelField;
import com.createbling.common.utils.excel.fieldtype.RoleListType;
...
public class User extends DataEntity<User>{
	...
	//tree的set、get方法
	@JsonIgnore
	@NotNull(message="所属tree不能为空")
	@ExcelField(title="所属tree", align=2, sort=20)
	public Area getArea() {
		return area;
	}
