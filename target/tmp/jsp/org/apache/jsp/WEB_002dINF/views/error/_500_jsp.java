...
// 输出异常信息页面
      ...
      out.write("\t\t\t<h1>系统内部错误.</h1>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<div class=\"errorMessage\">\n");
      out.write("\t\t\t错误信息：");
      out.print(ex==null?"未知错误.":StringUtils.toHtml(ex.getMessage()));
      out.write("\n");
      out.write("\t\t\t<br /> <br /> 请点击“查看详细信息”按钮，将详细错误信息发送给系统管理员，谢谢！<br /> <br /> <a\n");
      out.write("\t\t\t\thref=\"javascript:\" onclick=\"history.go(-1);\" class=\"btn\">返回上一页</a>\n");
      out.write("\t\t\t&nbsp; <a href=\"javascript:\" onclick=\"$('.errorMessage').toggle();\"\n");
      out.write("\t\t\t\tclass=\"btn\">查看详细信息</a>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<div class=\"errorMessage hide\">\n");
      out.write("\t\t\t");
      out.print(StringUtils.toHtml(sb.toString()));
      out.write("\n");
      out.write("\t\t\t<br /> <a href=\"javascript:\" onclick=\"history.go(-1);\" class=\"btn\">返回上一页</a>\n");
      out.write("\t\t\t&nbsp; <a href=\"javascript:\" onclick=\"$('.errorMessage').toggle();\"\n");
      out.write("\t\t\t\tclass=\"btn\">隐藏详细信息</a> <br /> <br />\n");
      out.write("\t\t</div>\n");
