...
static {
  ...
  _jspx_fnmap_2.mapFunction("fns:escapeHtml", com.createbling.common.utils.Encodes.class, "escapeHtml", new Class[] {java.lang.String.class});
}
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<thead>\n");
      out.write("\t\t\t<tr>\n");
      out.write("\t\t\t\t<th>操作菜单</th>\n");
      out.write("\t\t\t\t<th>操作用户</th>\n");
      out.write("\t\t\t\t<th>所在基地信息</th>\n");
      out.write("<!-- \t\t\t\t<th>所在部门</th> -->\n");
      out.write("\t\t\t\t<th>URI</th>\n");
      out.write("\t\t\t\t<th>提交方式</th>\n");
      out.write("\t\t\t\t<th>操作者IP</th>\n");
    ...
    try {
      ...
      if (_jspx_eval_form_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\" />\n");
          out.write("\t\t<div>\n");
          out.write("\t\t\t<label>操作菜单：</label><input id=\"title\" name=\"title\" type=\"text\"\n");
          out.write("\t\t\t\tmaxlength=\"50\" class=\"input-mini\" value=\"");
          ...
          out.write("\" /> <label>用户ID：</label><input\n");
          out.write("\t\t\t\tid=\"createBy.id\" name=\"createBy.id\" type=\"text\" maxlength=\"50\"\n");
          out.write("\t\t\t\tclass=\"input-mini\" value=\"");
          ...
          out.write("\" /> <label>URI：</label><input\n");
          out.write("\t\t\t\tid=\"requestUri\" name=\"requestUri\" type=\"text\" maxlength=\"50\"\n");
          out.write("\t\t\t\tclass=\"input-mini\" value=\"");
          ...
          out.write("\t\t\t<label>日期范围：&nbsp;</label><input id=\"beginDate\" name=\"beginDate\"\n");
          out.write("\t\t\t\ttype=\"text\" readonly=\"readonly\" maxlength=\"20\"\n");
          out.write("\t\t\t\tclass=\"input-mini Wdate\"\n");
          out.write("\t\t\t\tvalue=\"");
          ...
          out.write("\t\t\t\tid=\"endDate\" name=\"endDate\" type=\"text\" readonly=\"readonly\"\n");
          out.write("\t\t\t\tmaxlength=\"20\" class=\"input-mini Wdate\"\n");
          out.write("\t\t\t\tvalue=\"");
          ...
          out.write("\"\n");
          out.write("\t\t\t\tonclick=\"WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});\" />&nbsp;&nbsp;\n");
          out.write("\t\t\t&nbsp;<label for=\"exception\"><input id=\"exception\"\n");
          out.write("\t\t\t\tname=\"exception\" type=\"checkbox\"\n");
          out.write("\t\t\t\t");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("</td>\n");
          out.write("\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${log.createBy.area.name}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\n");
          out.write("\t\t\t\t\t<td><strong>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${log.requestUri}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</strong></td>\n");
